multi-threaded search for filenames on remote machines, returning the root path if the file exists.. Reduced work time from 15 minutes to approximately 2 minutes.
